...
<!-- 						</fo:block> -->
					...
					<fo:block padding-bottom="4mm">Thank you for signing up for Pre-Authorized Debits with EBSCO Canada LTD ("<fo:inline font-weight="bold">Ebsco</fo:inline>"). We have accepted your PAD Agreement and are writing to confirm the following details: </fo:block>
						...
						<fo:block padding-bottom="4mm">
							Your Payor's PAD Agreement may be cancelled provided notice is received 7 days before the next scheduled PAD. If any of the above details are incorrect, please contact us immediately at <fo:inline font-weight='bold'>finance@EBSCO.com</fo:inline>.If the details are correct, you do not need to do anything further and your Pre-Authorized Debits will be processed and start on the Payment Start Date indicated above.
							</fo:block>
...
<!--						<fo:list-item padding-bottom="4mm">
						...
						<fo:list-item padding-bottom="4mm">
					    	...
					    	<fo:list-item-body start-indent="1.6cm">
						    	<fo:block>
									<fo:inline font-weight='bold'>Assignment and Enurement:</fo:inline> EBSCO may assign at any time all or a portion of its rights and obligations under this PAD Agreement.   You may not assign this PAD Agreement or any of your rights or obligations under this PAD Agreement.  All of EBSCO rights under this PAD Agreement shall enure to the benefit of its successors and assigns.
								</fo:block>
					    	</fo:list-item-body >
						</fo:list-item>
						<fo:list-item padding-bottom="4mm">

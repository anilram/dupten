...
import com.ar.dupten.model.TrendingEvents;
import com.ar.dupten.util.DownloadImageTask;
...
public class TrendingEventsListAdapter extends BaseAdapter{
	...
	private List<TrendingEvents> trendingEvents;
	 public final static String[] imageThumbUrls = new String[] {
         ...
         "http://s2.www.astronomycameras.com/data/blog/20070809/assets/aubry_moon_zoom.jpg",
	...
	public TrendingEventsListAdapter(Activity activity, List<TrendingEvents> trendingEvents) {
		super();
		this.activity = activity;
		
		this.trendingEvents = new ArrayList<TrendingEvents>(trendingEvents);
	}
	@Override
	public int getCount() {
		// TODO Auto-generated method stub
		return trendingEvents.size();
	}
	@Override
	public Object getItem(int position) {
		// TODO Auto-generated method stub
		return trendingEvents.get(position);
	}
	@Override
	...
	public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null) {        	
        	convertView = inflater.inflate(R.layout.trend_list_row, null);
        	holder = new ViewHolder();
        	holder.titleView = (TextView) convertView.findViewById(R.id.t_title);
        	holder.locView = (TextView) convertView.findViewById(R.id.t_location);
	        holder.dateView = (TextView) convertView.findViewById(R.id.t_date);
	        holder.numPeopleView = (TextView) convertView.findViewById(R.id.t_number);
	        holder.thumbnail = (ImageView) convertView.findViewById(R.id.t_thumbnail);
	        holder.bar = (ProgressBar) convertView.findViewById(R.id.t_bar);
	        convertView.setTag(holder);
        }else{
        		holder = (ViewHolder)convertView.getTag();
			}
        Log.d("pos", ""+position);
       	DownloadImageTask.getInstance().loadBitmap(imageThumbUrls[position], holder.thumbnail,holder.bar);
        TrendingEvents trendingEvent = trendingEvents.get(position);        
        holder.titleView.setText(trendingEvent.getTitle());
        holder.locView.setText(trendingEvent.getLocation());
        holder.dateView.setText(trendingEvent.getDate());
        holder.numPeopleView.setText(""+trendingEvent.getNumPeople());
		return convertView;
	}
